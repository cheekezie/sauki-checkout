...
export default function NotFound() {
  ...
  return (
    <section className='flex justify-center items-center h-screen'>
      <div className='px-4 mx-auto max-w-7xl lg:py-20 lg:px-6'>
        {/* Center content vertically */}
        <div className='mx-auto max-w-screen-sm text-center'>
          <h1 className='mb-4 text-7xl tracking-tight font-extrabold lg:text-9xl text-primary'>404</h1>
          <p className='mb-4 text-2xl font-bold text-gray-800'>We can't seem to find the page you are looking for</p>
