		...
		<AuthLayout>
			<div className='mb-8'>
				...
				<p className='text-muted-foreground'>
					Lorem ipsum dolor sit amet consectetur. Etiam vehicula posuere quam orci
					suspendisse.
				</p>
			</div>
			...
			<form onSubmit={onSubmit} className='space-y-4'>
				...
				<div className='flex items-center justify-between'>
					...
					<Link
						to='/forget-pin'
						className='text-primary font-normal hover:text-primary/80 cursor-pointer text-sm'>
						Forgot Password
					</Link>
				</div>
			...
			<div className='mt-8'>
				<div className='text-center mb-4'>
					<p className='text-muted-foreground text-sm'>
						Easily Sign up With Social Media Links
					</p>
				</div>
